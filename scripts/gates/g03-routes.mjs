...
const BASELINE_EXPECTED_ROUTES = '1183/1066'; // v4 r1: +5 blog guides (F) and +20 indexed brands; 533 indexed + 68 + 10 series + 5 guides // v3: 513 indexed brands + 68 other + 10 series = 591 in sitemap; 1009 + 68 + 10 series = 1087 prerendered (was 1079/507) // Branduri-500 v2: 1009 brands + 68 other = 1077 prerendered; 1077 - 45 - (726-212+? ) noindex = 505 in sitemap (was 825/406 after v1)
