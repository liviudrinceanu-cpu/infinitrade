export const brandContentBatch13 = {
  'omron': {
    founded: 1933,
...
Din 1933 până azi, Omron a livrat peste 200 milioane de relee, 100 milioane de senzori și sisteme de automatizare în peste 120 țări. Investiția lor anuală în R&D depășește 7% din cifra de afaceri - resurse alocate către IoT industrial, inteligență artificială aplicată și soluții de economisire a energiei. Noi furnizăm Omron pentru că aduce rezultate măsurabile: reducere costuri operaționale, creștere productivitate și flexibilitate în producție. Când un client ne spune că linia nouă cu Omron a atins ROI în sub 18 luni, știm că am recomandat tehnologia potrivită.`,
    whyChoose: [
      'PLC-uri Sysmac cu performanță de top și programare IEC 61131-3 completă',
...
Fabricile Optibelt din Germania și facilitatea din SUA produc peste 15 milioane metri liniari de curele anual. Investiții continue în R&D au dus la patente pentru structuri cord hibrid și profile geometrice optimizate. Certificările DIN, ISO și homologările OEM de la Mercedes, Bosch, Atlas Copco confirmă că vorbim de top tier în transmisii. Noi distribuim Optibelt pentru că eliminăm downtimele neprogramate - o curea de calitate superioară costă cu 20% mai mult, dar durează de 3 ori mai mult și nu cedează brusc.`,
    whyChoose: [
      'Calitate germană cu peste 150 ani experiență în transmisii',
      'Curele RED POWER III cu durată de viață dublă față de clasice',
    ...
    keyProducts: [
      {
        ...
        description: 'Top de gamă Optibelt pentru transmisii industriale clasice. Structură cu corzi aramidice încastrate în elastomer HNBR rezistent termic și chimic. Îmbunătățiri față de generațiile anterioare: rezistență la tracțiune cu 30% mai mare, flexibilitate crescută (roți minime mai mici), antistatice conform ISO 1813. Profile disponibile: SPZ, SPA, SPB, SPC (metrice) și 3V, 5V, 8V (inch). Temperatura operare -30°C până +100°C continuu. Testele noastre arată că RED POWER III rulează de 2-3 ori mai mult decât curele standard în condiții identice. Rezistență la ulei mineral, biodiesel, ozon. Aplicații tipice: compresoare, pompe, ventilatoare industriale, agregate frigorifice. Montaj simplu fără pre-tensionare excesivă - cordul aramidic nu se întinde. Recomandăm verificare tensiune la 24h după montaj și retensionare dacă e cazul. Disponibile în lungimi standard sau fabricate la comandă pentru aplicații speciale.'
      },
      {
    ...
    keyProducts: [
      {
        ...
        description: 'Cartuș filtrare absolută cu membrană polyethersulfone hidrofil asimetric. Retenție garantată 0.2 μm sau 0.45 μm conform ASTM F838. Eficiență 99.9999% (LRV >7) pe Brevundimonas diminuta. Suprafață filtrare 2.5 m²/cartus 10" standard - throughput mare la presiune diferențială mică. Constructie double-layer asigură rezistență mecanică și prefiltrare integrată. Compatibilitate chimică excelentă: acizi, baze, solventi, soluții apoase și organice. Temperatura până la 80°C sterilizare cu abur, autoclavabil la 121°C. Aplicații: filtrare sterilă soluții parenterale, vaccinuri, produse biologice, medii de cultura stele, apă pentru injectabile. Validare conform FDA CFR 21 Part 211 - documente complete pentru audit. Integritate testabilă prin bubble point, diffusion sau pressure hold test. Carcasă 316L electropolished pentru aplicații sanitare. Conexiuni Tri-Clamp, DIN 11851, flanșe ANSI. Disponibili în 5", 10", 20", 30", 40" lungimi. Extractables și leachables la nivele ultra-joase conform USP <665>.'
      },
      {
...
P+F investește peste 10% din cifra de afaceri în R&D - facilități de testare la Mannheim și Singapore pentru validare Ex și medii extreme. Peste 6,000 brevete active și certificări în 40+ țări. Gama lor se extinde de la senzori simpli de câțiva euro până la sisteme process automation de sute de mii euro pentru rafinate și platforms offshore. Noi distribuim Pepperl+Fuchs pentru că oferă soluția certificată pentru orice aplicație - fie că e zonă sigură sau ATEX Zona 0, fie că vorbim de tracking asset-uri sau vision inspection.`,
    ...
    certifications: [
      'ATEX - Zone explozive Europa',
      'IECEx - Zone explozive internațional',
      'FM, CSA - Certificate Nord America',
      'SIL2/SIL3 - Functional safety (produse selectate)',
      'ISO 9001 - Management calitate',
      'ISO 14001 - Management mediu',
      'UL, CE - Certificate generale produse',
      'NAMUR - Conformitate standarde industrie proces'
    ],
    industries: [
      'oil-gas',
      'chemical',
...
Prezența globală în peste 100 țări și 50+ facilități de producție asigură availability și suport local. Phoenix Contact investește 8% din cifra de afacari în R&D - focus pe digitalizare, energie regenerabilă, electromobilitate. Certificări complete: ISO 9001, ISO 14001, ATEX, UL, CSA, certificare hardware/software conform IEC 61508 pentru funcții safety. Noi distribuim Phoenix Contact pentru că oferă soluția completă și integrată - de la alimentare și protecție până la control și comunicație IoT - totul din aceeași sursă cu compatibilitate garantată.`,
    ...
    certifications: [
      'ISO 9001 - Management calitate',
      'ISO 14001 - Management de mediu',
      'IEC 61508 SIL3 - Safety certified products',
      'UL, CSA - Certificate Nord America',
      'ATEX - Componente pentru zone Ex',
      'CE - Conformitate directivele UE',
      'DNV, ABS - Certificate marine',
      'RoHS, REACH - Conformitate substanțe'
    ],
    industries: [
      'automotive',
...
Cu facilități de producție în Italia și distribution în 60+ țări, Pneumax combină manufacturing tradițional italian cu supply chain modern. Certificări ISO 9001, componente conform EN ISO 15552, valve conform ISO 5599-1. Time-to-market scurt pentru produse custom - engineerii Pneumax modifică și produc cilindri speciali în 2-3 săptămâni vs 8-12 săptămâni la giganți. Noi distribuim Pneumax pentru că oferă sweet spot între calitate europeană și flexibilitate - componente fiabile la preț competitiv cu delivery rapid și suport tehnic responsive.`,
    whyChoose: [
    ...
    certifications: [
      'ISO 9001 - Management calitate producție',
      'ISO 15552 - Standard cilindri pneumatici',
      'ISO 5599-1 - Standard valve pneumatice',
      'CE - Conformitate directive UE',
      'RoHS - Conformitate substanțe',
