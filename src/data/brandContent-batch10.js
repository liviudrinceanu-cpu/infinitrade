export const brandContentBatch10 = {
  'ifm': {
    founded: 1969,
...
Ceea ce ne diferențiază este abordarea sistemică: nu vindem doar senzori, ci soluții complete de monitorizare și diagnostic predictiv. Platformele producătorului moneo și ecosys permit analiza în timp real a semnalelor de la sute de senzori, detectarea anomaliilor și planificarea întreținerii înainte ca defecțiunile să apară. Asta înseamnă costuri mai mici, timp de nefuncționare zero și eficiență crescută pentru clienții producătorului din automotive, food & beverage, logistică, chimie și energie.`,
    ...
    certifications: [
      ...
      'SIL 2/3 - Certificare funcțională siguranță conform IEC 61508',
      'ATEX/IECEx - Aparate pentru atmosfere explozive zona 0/1/2',
      'UL/CSA - Certificări pentru piața nord-americană',
      '3-A Sanitary - Aprobări pentru industria alimentară',
      'EHEDG - Certificare design igienic European'
    ],
    industries: [
      'Automotive - detecție piese, monitorizare presiune, control calitate',
      'Food & Beverage - senzori igienici, debitimetre sanitare, trasabilitate',
      'Logistică - identificare palete, ghidare AGV, management flux',
      'Chimie & Petrochimie - senzori ATEX, monitorizare procese critice',
      'Water Treatment - măsurare debit, presiune, nivel, calitate apă',
      'Mobile Hydraulics - presiune, temperatură ulei, control proporțional',
      'Packaging - detecție produse, control poziție, numărare cutii',
      'Energie regenerabilă - monitorizare turbine, panouri, baterii',
...
Peste 400 de ingineri, tehnicieni și operatori lucrează zilnic pentru ca fiecare filtru Internormen să îndeplinească standardele stricte germane. Colaborăm direct cu producători de excavatoare, macarale, prese hidraulice, sisteme de injecție, turbine eoliene și centrale hidroelectrice. Oriunde găsești un sistem hidraulic de putere mare care trebuie să funcționeze fără eroare ani la rând, probabil vei găsi și un filtru Internormen.`,
    ...
    certifications: [
      'ISO 9001:2015 - Sistem calitate certificat DQS',
      'ISO 14001:2015 - Management de mediu',
      'ISO 16889 - Certificare Beta ratio în laboratoare acreditate',
      'ISO 4406 - Clasificare curățenie ulei hidraulic',
      'VDMA 24568 - Standard german filtre hidraulice',
      'CE - Conformitate directivele europene',
      'RoHS compliant - Fără substanțe periculoase',
      'REACH registered - Conformitate reglementare chimicale EU'
    ],
    industries: [
      'Mobile Hydraulics - excavatoare, buldozere, macarale, combine agricole',
      'Machine Tools - prese hidraulice, strunguri CNC, rectificatoare',
      'Steel Industry - laminoare, forfecă, cilindri reglare',
      'Plastics - mașini injecție, extrudare, suflare',
      'Marine & Offshore - sisteme servo timone, stabilizatoare, winch-uri',
      'Wind Energy - sisteme pitch și yaw turbine eoliene',
      'Hydropower - turbine Kaplan/Francis, servomotoare palete',
      'Mining - sisteme hidraulice excavatoare, transportoare',
...
Ceea ce ne diferențiază este consecvența calității: fiecare siguranță Jean Müller fabricată astăzi are exact aceleași caracteristici I²t și caracteristică timp-curent ca una fabricată acum 20 de ani cu același cod. Asta înseamnă că poți completa un set vechi fără să recalculezi selectivitatea sau să schimbi întreaga instalație. Pentru electricieni și ingineri de mentenanță, asta înseamnă liniște și predictibilitate într-o lume în care echipamentele se schimbă constant.`,
    ...
    industries: [
      ...
      'Mining - transformatoare mină, motoare excavatoare',
      'Railways - alimentare trenuri, stații de tracțiune',
      'Steel & Metallurgy - cuptoare arc electric, laminoare',
      'Chemical - pompe, compresoare, agitatori zone ATEX',
...
Ceea ce ne face preferați de inginerii de proces este versatilitatea: același regulator JUMO poate controla temperatură, presiune, nivel sau pH doar schimbând senzorul și câțiva parametri software. Platformele producătorului mTRON și AQUIS permit automatizarea completă a proceselor complexe - de la fermentare bere la sterilizare autoclave, de la congelare blast-chiller la pasteurizare lapte. Integrare nativă PROFIBUS, PROFINET, Modbus și OPC UA facilitează conectarea la sisteme SCADA și MES.`,
    ...
    certifications: [
      'ISO 9001:2015 - Management calitate certificat DQS',
      'ISO 14001:2015 - Management de mediu',
      'DAkkS - Laborator calibrare acreditat național Germania',
      'ISO 17025 - Competență laborator testare și calibrare',
      '3-A Sanitary Standards - Echipamente contact alimente',
      'EHEDG - Design igienic certificat European',
      'FDA 21 CFR Part 11 - Software validare industrie farmaceutică',
      'ATEX/IECEx - Senzori pentru atmosfere explozive',
      'SIL 2 - Certificare funcțională siguranță'
    ],
    industries: [
      'Food & Beverage - pasteurizare, sterilizare, fermentare, congelare',
      'Pharmaceutical - autoclaves, clean rooms, bioreactoare',
      'Chemical - reactoare, distilare, cristalizare, polimerizare',
      'Water Treatment - filtrare, dezinfecție, pompare, stocare',
      'HVAC - centrale termice, răcitoare, ventilatoare, umidificare',
      'Plastics - extrudare, injecție, suflare, termoformare',
      'Paper & Pulp - uscătoare cilindrice, calandre, digestoare',
      'Automotive - vopsitorie, tratament termic, teste climatice',
...
Investim anual peste 100 milioane EUR în cercetare și dezvoltare - avem peste 1,000 de brevete active pentru tehnologii de pulverizare, aspirare, filtrare și robotică. Toate produsele sunt testate în laboratoare proprii la zeci de mii de ore funcționare simulată înainte de lansare. Rezultatul: utilaje care își mențin performanța și eficiența chiar și după 10,000-15,000 ore de utilizare, cu costuri de mentenanță minime și timp de nefuncționare aproape zero.`,
    ...
    industries: [
      ...
      'Airports - terminale, hangare, piste, zone bagaje',
      'Healthcare - spitale, clinici, laboratoare, camere curate',
      'Public Transport - gări, metrou, stații autobuz, tramvaie',
...
Avem expertiză extinsă în aplicații extreme: traductoare submersibile până la 5,000 metri adâncime oceană, senzori pentru 700 bar presiune hidraulică în prese de forjare, transmițătoare wireless pentru monitorizare baraje cu autonomie 10 ani pe baterie. Colaborăm cu NASA pentru senzori aerospace, cu Schlumberger pentru sonde petroliere de 10 km adâncime și cu CERN pentru sisteme criogenice la -269°C. Dacă măsurarea trebuie să fie perfectă, alegi Keller.`,
    ...
    certifications: [
      'ISO 9001:2015 - Management calitate certificat SGS',
      'ISO 14001:2015 - Management de mediu',
    ...
    industries: [
      ...
      'Automotive - teste presiune combustibil, frână, suspensie',
      'Aerospace - măsurare altitudine, viteză aer, presiune cabină',
      'Chemical - reactoare sub presiune, distilare, polimerizare',
...
Ceea ce ne diferențiază este suportul tehnic: când cumperi un lubrifiant Klüber, primești acces la o echipă de tribologi care analizează aplicația ta, testează compatibilitatea materialelor, calculează intervalul de reungere și monitorizează performanța în timp. Colaborăm cu BMW pentru unsori transmisii electrice, cu SKF pentru preungere lagăre, cu NASA pentru lubrifianți aerospace și cu Nestlé pentru unsori food-grade. Unde fiabilitatea contează mai mult decât prețul, alegi Klüber.`,
    ...
    certifications: [
      'ISO 9001:2015 - Management calitate certificat DQS',
      'ISO 14001:2015 - Management de mediu',
      'ISO 21469 - Lubrifianți pentru industria alimentară',
      'NSF H1 - Food-grade pentru contact accidental cu alimente',
      'Halal & Kosher - Certificări religioase pentru food industry',
    ...
    industries: [
      ...
      'Food & Beverage - transportoare, mixere, valve, pompe dosare',
      'Pharmaceutical - tablete prese, capsule filling, ambalare blister',
      'Paper & Pulp - cilindri uscătoare, reductoare, lanțuri transport',
      'Steel - laminoare, cilindri backup, rulmenți furnal',
      'Chemical - pompe dozare, agitatoare, valve ATEX',
      'Textil - filatură, țesătorie, vopsitorie, calandre',
      'Wind Energy - rulmenți pitch/yaw, reductoare principale',
...
Ceea ce ne diferențiază este expertiza aplicativă: inginerii noștri au rezolvat peste un milion de aplicații complexe - de la măsurarea bitumenului la 180°C până la debit gaz natural la -40°C, de la pastă de celuloză cu 5% consistență până la acid sulfuric 98%. Colaborăm cu BASF, Shell, ExxonMobil, Nestlé, Coca-Cola pentru sisteme de măsurare critice unde precizia înseamnă profit sau pierdere de milioane de euro pe an. Dacă măsurarea debitului contează pentru procesul tău, alegi Krohne.`,
    ...
    certifications: [
      'ISO 9001:2015 - Management calitate certificat DQS',
      'ISO 14001:2015 - Management de mediu',
      'ISO/IEC 17025 - Laborator calibrare acreditat DAkkS',
      'OIML R117/R137 - Aprobări metrologice apă potabilă',
      'MID 2014/32/EU - Directive instrumente măsurare EU',
      'ATEX/IECEx - Certificare zona 0/1/2 gaz și praf',
      'SIL 2/3 - Certificare funcțională siguranță IEC 61508',
      'WHG - Aprobări germane substanțe poluante apă',
      '3-A Sanitary / EHEDG - Certificări food/pharma',
      'PED 2014/68/EU - Directive echipamente sub presiune'
    ],
    industries: [
      'Oil & Gas - măsurare custody transfer, alocare producție, fiscal metering',
      'Chemical & Petrochemical - reactoare batch, distilare continuă, blending',
      'Water & Wastewater - facturare apă potabilă, control stații epurare',
      'Food & Beverage - dozare ingrediente, CIP, pasteurizare, fermentare',
      'Pharmaceutical - reactoare sterile, WFI, dozare API',
      'Power Generation - măsurare combustibil, apă alimentare, abur',
      'Pulp & Paper - white/black liquor, coating, waste water',
      'Mining & Metals - acid sulfuric, suspensii minerale, lăcuire',
...
Fiecare cablu Lapp este conceput pentru rezistență maximă în condiții industriale reale: 10 milioane de cicluri flexiune pe lanț purtător, temperaturi de la -50°C până +180°C, rezistență la uleiuri minerale și sintetice, acizi, baze, ozoni UV, flacără conform IEC 60332. Testăm toate produsele în laboratoarele proprii certificate și colaborăm direct cu producători de mașini și roboți pentru a optimiza designul pentru aplicații specifice. Când cablul trebuie să reziste ani la rând fără eroare, alegi Lapp.`,
    ...
    certifications: [
      ...
      'ISO 14001:2015 - Management de mediu',
      'ISO 50001 - Management energie',
      'UL - Certificare cabluri pentru piața SUA/Canada',
      'CSA - Certificare Canada',
      'CE - Conformitate directivele europene',
      'PROFIBUS/PROFINET - Certificare comunicație industrială',
      'EtherCAT - Certificare Beckhoff',
      'RoHS/REACH compliant - Fără substanțe periculoase',
      'CPR - Construction Product Regulation pentru cabluri clădiri'
    ],
    industries: [
      'Machine Building - mașini-unelte, ambalare, imprimare, textile',
      'Automotive - roboți sudură, linii asamblare, AGV',
      'Food & Beverage - transportoare, dozare, ambalare în medii umede',
      'Intralogistics - conveyors, sortare, paletizare, AGV/AMR',
      'Robotics - roboți industriali, coboți, manipulatoare',
      'Renewable Energy - panouri fotovoltaice, turbine eoliene',
      'Railways - trenuri, tramvaie, metrou, infrastructură',
      'Marine & Offshore - nave, platforme petroliere, porturi',
