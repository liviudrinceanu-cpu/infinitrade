...
Din seria 8524 aducem celule noi la comandă prin furnizori din Uniunea Europeană, în termen de 2–6 săptămâni. Pentru înlocuirea unei celule existente, clientul trimite codul complet de pe eticheta aparatului sau, dacă lipsește, domeniul de măsurare necesar și tipul de solicitare (tracțiune, compresiune sau ambele); confirmăm varianta potrivită din documentația producătorului înainte de ofertă.`,
    models: [
      { code: '8524 (0...±500 N)', note: 'domeniul minim de măsurare al seriei.' },
      { code: '8524 (0...±1 kN)', note: 'domeniu de măsurare din gama seriei.' },
      { code: '8524 (0...±5 kN)', note: 'domeniu de măsurare din gama seriei.' },
      { code: '8524 (0...±20 kN)', note: 'prag de la care clasa de protecție devine IP67.' },
      { code: '8524 (0...±100 kN)', note: 'domeniu de măsurare din gama seriei.' },
      { code: '8524 (0...±200 kN)', note: 'domeniul maxim de măsurare al seriei.' },
    ],
    specs: [
      { label: 'Domeniu de măsurare', value: '±500 N – ±200 kN', unit: '' },
      { label: 'Semnal de ieșire', value: '1,5', unit: 'mV/V' },
      { label: 'Temperatură de funcționare', value: '-30…+80', unit: '°C' },
      { label: 'Clasă de protecție', value: 'IP65 (≤10 kN) / IP67 (≥20 kN)', unit: '' },
      { label: 'Abatere de liniaritate', value: '≤0,1', unit: '% F.S. (opțional)' },
      { label: 'Material carcasă', value: 'oțel inoxidabil', unit: '' },
    ],
    applications: [
      { name: 'Măsurarea forțelor de tracțiune și compresiune statice, cvasi-statice și dinamice.' },
    ],
    accessories: [
      { code: 'burster TEDS', note: 'Modul electronic de identificare a senzorului, disponibil opțional.' },
    ],
    faq: [
      { q: 'Ce informații sunt necesare pentru o ofertă la seria 8524?', a: 'Codul complet de pe eticheta celulei, de exemplu 8524-6100, sau, dacă lipsește, domeniul de măsurare dorit și tipul de solicitare: tracțiune, compresiune sau ambele. Aceste date permit identificarea variantei corecte din documentația producătorului înainte de ofertă.' },
      { q: 'Celulele din seria 8524 pot măsura atât tracțiune, cât și compresiune?', a: 'Da, seria este construită pentru măsurarea forțelor de tracțiune și compresiune statice, cvasi-statice și dinamice. Domeniul exact depinde de varianta comandată, de la 500 N până la 200 kN, conform documentației producătorului.' },
    ],
    ...
    sources: [
      ...
      { title: 'Tension and compression load cells', url: 'https://www.burster.com/products/sensors/load-cells/tension-and-compression-force-sensors', publisher: 'burster präzisionsmesstechnik GmbH & Co KG', accessed: '2026-09-23' },
    ],
