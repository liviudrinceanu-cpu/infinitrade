...
export const series = [
  {
    ...
    "models": [
      {
        "code": "LA36",
        "note": "Varianta standard, interfață LINAK I/O, tensiuni 12/24/36/48 V DC."
      },
      {
        "code": "LA36 IC",
        "note": "Cu Integrated Controller, interfețe CANopen, Modbus, PROFINET, EtherNet/IP."
      },
      {
        "code": "LA36 ATEX/IECEx",
        "note": "Variantă certificată pentru medii cu praf exploziv."
      },
      {
        "code": "LA36 Off-Highway",
        "note": "Variantă pentru utilaje agricole și alte aplicații off-highway."
      },
      {
        "code": "36 120 200 0 A 01 B 6-611H30300NCS000",
        "note": "Exemplu de cod de comandă din fișa tehnică: 12 V, cursă 200 mm."
      }
    ],
    "specs": [
      {
      ...
      {
        "label": "Grad de protecție, dinamic",
        "value": "IP66",
        "unit": ""
      },
      {
        "label": "Grad de protecție, static",
        "value": "IP69K",
        "unit": ""
      }
    ],
    "applications": [
      ...
      "Urmărire solară și eoliană"
    ],
    "accessories": [
      "CAB0367046 — Cablu de alimentare, lungimi 1500/5000/10000 mm.",
      "CAB0367049 — Cablu de semnal cu 6 pini, aceleași lungimi.",
      "CAB0368543 — Cablu de semnal cu 9 pini, aceleași lungimi."
    ],
    "faq": [
      {
        "q": "Ce trebuie să trimit pentru o ofertă la LA36?",
        "a": "Codul complet de configurare de pe eticheta actuatorului, dacă este lizibil. Când eticheta lipsește, este suficient să precizați cursa, tensiunea de alimentare și forța maximă necesară, plus interfața de comunicație dorită, dacă aplicația o cere."
      },
      {
        "q": "Ce nu putem confirma pentru LA36?",
        "a": "Nu confirmăm din surse proprii compatibilitatea electronică exactă cu un anumit sistem de control fără a verifica fișa tehnică curentă a producătorului pentru interfața cerută. Nu promitem termene mai scurte decât intervalul de aprovizionare din UE."
      },
      {
        "q": "Se poate comanda LA36 cu montaj special sau conectori Deutsch?",
        "a": "Da, gama LA36 permite alegerea unghiului de fixare, a tipului de ochi al tijei și a conectorilor, inclusiv variante Deutsch cu 2, 6/8 sau 12 pini, conform codului de comandă din fișa tehnică."
      }
    ],
    ...
    "sources": [
      {
        "title": "LA36 — Linear actuator",
        "url": "https://www.linak.com/products/linear-actuators/la36/",
        "publisher": "LINAK",
        "accessed": "2026-09-23"
      },
      {
        "title": "LA36 Data Sheet",
        "url": "https://assets.linak.com/asset/590184044899/document_305oo2h9ah3sl80jn04pmbns64?content-disposition=inline",
        "publisher": "LINAK",
        "accessed": "2026-09-23"
      }
    ],
