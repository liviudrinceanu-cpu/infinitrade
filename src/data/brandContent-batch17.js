...
Corpurile se execută din oțel carbon, oțel inoxidabil austenitic sau aliaje speciale precum Hastelloy și Monel pentru medii puternic corozive, iar dimensionarea orificiului urmează literele API 526 (D până la T) pentru compatibilitate directă cu proiectele existente. Temperaturile acoperite merg de la aplicații criogenice, pentru terminale LNG, până la peste 550°C pentru linii de abur supraîncălzit din centrale electrice. Supapele LESER sunt certificate TÜV și PED 2014/68/UE și, pentru piața americană, ASME, și se regăsesc pe conducte de proces din rafinării, platforme petroliere, fabrici chimice, centrale electrice și instalații de gaz industrial din toată lumea.`,
    ...
    industries: [
      "Rafinării și petrochimie — protecția la suprapresiune a coloanelor, recipientelor și conductelor de proces",
      "Producție și distribuție de gaze industriale — stocare și transport GPL, azot, oxigen",
      "Energie și termocentrale — linii de abur supraîncălzit, cazane de abur, turbine",
      "Platforme offshore și industria petrolieră — echipamente de proces expuse la medii saline și corozive",
      "Industria chimică — reactoare și recipiente sub presiune pentru medii agresive",
      "Terminale LNG și aplicații criogenice — supape pentru temperaturi extrem de scăzute",
      "Construcția de cazane și compresoare — supape OEM pentru utilaje noi"
    ],
    certifications: [
      "PED 2014/68/UE — conformitate pentru echipamente sub presiune comercializate în UE",
      "ASME — certificare acceptată pentru proiecte de rafinării și platforme destinate pieței nord-americane",
...
Ce diferențiază GESTRA este abordarea de sistem: nu vinde doar o oală de condens izolată, ci propune soluții complete de recuperare a condensului și a energiei termice asociate, cu monitorizare digitală prin senzori care semnalează din timp o oală blocată sau care lasă abur să treacă. Produsele se regăsesc în centrale termice și electrice, rafinării, fabrici de hârtie, industria alimentară și oriunde aburul este folosit ca agent termic de proces. Pentru un operator de cazane, o rețea GESTRA corect dimensionată înseamnă mai puține pierderi de abur, un consum de combustibil mai mic și un risc redus de avarii cauzate de nivel scăzut de apă.`,
    ...
    keyProducts: [
      ...
      },
      {
        ...
        description: "Sistemele NRG folosesc electrozi de conductivitate montați direct pe cazan pentru a detecta nivelul apei și a preveni funcționarea la sec, cauza cea mai frecventă a avariilor grave la cazanele de abur. Semnalul este transmis către un regulator care oprește arderea sau alimentarea în funcție de pragurile setate — nivel minim de alarmă, nivel minim de oprire și, opțional, nivel maxim. Construcția fără piese mobile în interiorul cazanului elimină riscul de blocare mecanică, un avantaj important față de plutitoarele clasice. Electrozii se livrează în lungimi diferite pentru a acoperi cazane de diverse înălțimi și se pot integra cu automatizări existente prin ieșiri analogice sau contacte de releu."
      },
      {
    ...
    industries: [
      "Centrale termice și electrice — cazane de abur, turbine, rețele de termoficare",
      "Rafinării și petrochimie — linii de abur de proces și recuperare condens",
      "Industria hârtiei și celulozei — uscătoare cu cilindri, prese termice",
      "Industria alimentară și a băuturilor — sterilizare, autoclave, procese termice",
      "Industria textilă — vopsitorii și finisaje cu abur",
      "Spitale și clădiri instituționale — sterilizare și încălzire centralizată cu abur",
      "Industria chimică — schimbătoare de căldură și reactoare încălzite cu abur"
    ],
    certifications: [
...
Materialele standard includ fontă ductilă cu acoperiri epoxidice conforme GSK sau RAL pentru protecție anticorozivă pe termen lung, iar garniturile de etanșare din EPDM sunt certificate pentru contact cu apa potabilă conform normelor europene. Pentru operatorii de utilități, avantajul robinetelor VAG constă în cuplul de manevră redus chiar și după ani de funcționare, datorită construcției fără frecare a sistemului de etanșare — o vană EKN se manevrează la fel de ușor la 20 de ani ca în prima zi. Domeniile principale de utilizare rămân stațiile de tratare a apei, rezervoarele de înmagazinare, stațiile de pompare și rețelele de distribuție și canalizare.`,
    whyChoose: [
    ...
    certifications: [
      "ISO 9001 — management al calității pentru proiectare și producție de armături",
      "GSK — acoperire epoxidică certificată pentru protecție anticorozivă pe termen lung",
...
Materialele acoperă de la fontă ductilă cu disc din oțel inoxidabil pentru aplicații generale, până la execuții integral din inox sau cu cauciucare specială pentru medii alimentare sau chimice agresive. Robinetele EBRO respectă cerințele de igienă din industria alimentară acolo unde discul și garnitura sunt certificate pentru contact alimentar, și sunt disponibile în execuții ATEX pentru zone cu risc de explozie. Se regăsesc frecvent în stații de tratare a apei, instalații de climatizare industrială, linii de proces din industria alimentară și rețele de distribuție a gazelor și lichidelor industriale, unde raportul preț-fiabilitate al construcției concentrice reprezintă principalul argument de alegere.`,
    ...
    industries: [
      "Tratarea și distribuția apei — stații de tratare, rețele industriale de apă tehnologică",
      "Climatizare industrială (HVAC) — izolare și reglare pe circuite de agent termic",
      "Industria alimentară și a băuturilor — linii de proces cu cerințe de igienă",
      "Industria chimică — izolare pe conducte cu medii agresive sau corozive",
      "Energie și utilități — sisteme de răcire și circuite auxiliare din centrale",
      "Construcția de utilaje și instalații OEM — robinet plus actuator ca subansamblu montat direct"
    ],
    certifications: [
...
Îmbinările se fac prin sudură cu electrofuziune sau sudură cap la cap, tehnologii care elimină practic riscul de scurgere la punctele de conexiune, spre deosebire de îmbinările filetate sau flanșate ale sistemelor metalice. Pentru monitorizarea proceselor, gama Signet de senzori de debit, pH, conductivitate și nivel se integrează direct în conducta din plastic, fără puncte suplimentare de coroziune. Sistemele GF Piping se regăsesc în tratarea apei și apei uzate, industria semiconductorilor, produse farmaceutice, industria alimentară și instalații chimice — oriunde greutatea redusă, rezistența la coroziune și costul de instalare mai mic al plasticului cântăresc mai mult decât rezistența mecanică superioară a metalului.`,
    ...
    keyProducts: [
      ...
      },
      {
        ...
        description: "COOL-FIT este un sistem de conducte preizolate din plastic, gândit pentru distribuția agentului de răcire, apă glicolată sau saramură, în industria alimentară, farmaceutică și clădiri comerciale mari. Izolația integrată elimină condensul de pe suprafața exterioară a conductei, o problemă frecventă și costisitoare la sistemele metalice neizolate corespunzător, și reduce pierderile termice pe traseu față de o conductă izolată separat pe șantier. Montajul prefabricat, cu fitinguri și coturi deja izolate din fabrică, scurtează timpul de instalare și elimină variabilitatea calității izolației aplicate manual, un avantaj important pe șantiere cu termene strânse."
      },
      {
        name: "Sisteme de Instrumentare Signet",
        description: "Gama Signet de senzori pentru debit, pH, conductivitate, turbiditate și nivel este proiectată pentru montaj direct în conducta din plastic GF, fără adaptoare suplimentare care ar introduce noi puncte de coroziune sau scurgere. Senzorii de debit funcționează pe principiul paletei rotative sau electromagnetic, în funcție de aplicație, cu ieșiri 4-20mA sau digitale pentru integrare în automatizarea existentă a instalației. Fiind gândiți special pentru sisteme de proces din industria apei, chimicale și alimentară, oferă o soluție unitară de monitorizare fără a fi nevoie de instrumentație separată, montată invaziv pe conductă prin găurire și adaptoare metalice."
      }
    ],
    industries: [
      "Tratarea apei și apei uzate — stații de tratare, desalinizare, rețele municipale",
      "Industria semiconductorilor — transport de chimicale ultra-pure, sisteme PVDF",
      "Industria farmaceutică — apă purificată, WFI, sisteme sanitare fără zone moarte",
      "Industria alimentară și a băuturilor — agent de răcire, procesare, spălare CIP",
      "Industria chimică — transport de acizi, baze și solvenți în conducte rezistente la coroziune",
      "Clădiri comerciale și industriale — sisteme de răcire preizolate COOL-FIT"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția sistemelor de conducte din plastic",
      "WRAS / DVGW — conformitate pentru sisteme de apă potabilă",
...
Materialele acoperă PVDF, PP și PVC pentru robinetele din plastic, și oțel inoxidabil 316L cu finisaje de suprafață controlate pentru variantele metalice folosite în farmaceutică și biotehnologie, unde rugozitatea suprafeței interioare este o cerință de proiect, nu doar o opțiune. GEMÜ oferă și electronică de proces proprie — poziționer, senzori de poziție și controlere — integrată direct pe robinet, ceea ce simplifică automatizarea liniilor noi. Produsele se regăsesc în fabrici farmaceutice, instalații de semiconductori, linii alimentare și stații de tratare a apei ultra-pure, oriunde cerințele de igienă depășesc ce poate oferi un robinet industrial standard.`,
    ...
    industries: [
      "Industria farmaceutică și biotehnologică — bioreactoare, linii de filtrare, sisteme CIP/SIP",
      "Industria alimentară și a băuturilor — procesare lichide, sisteme de igienizare",
      "Semiconductori — transport de chimicale ultra-pure în procesele de fabricație",
      "Tratarea apei ultra-pure — sisteme de osmoză inversă și deionizare",
      "Industria chimică — reglare și izolare pe linii cu medii agresive",
      "Cosmetice — procesare și ambalare de produse lichide sensibile la contaminare"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția robineților cu membrană",
      "FDA — elastomeri și materiale de membrană aprobate pentru contact alimentar și farmaceutic",
      "EHEDG — conformitate cu cerințele de proiectare igienică pentru industria alimentară",
  ...
  lowara: {
    ...
    overview: `Lowara este un producător italian de pompe centrifuge, fondat în 1958 la Montecchio Maggiore, azi parte a grupului american Xylem, unul dintre cei mai mari jucători globali din tehnologia apei. Rămâne totuși un brand cu identitate proprie și fabrică dedicată în Italia, axat pe pompe pentru clădiri, industrie și irigații — segmentul unde eficiența energetică și fiabilitatea pe termen lung contează la fel de mult ca prețul de achiziție. Gama acoperă de la circulatoare mici pentru instalații rezidențiale, până la pompe multietajate verticale pentru presurizare industrială și stații de pompare municipale.
...
Circulatoarele Ecocirc, cu motor cu rotor umed și reglare electronică a turației, reduc consumul energetic al circuitelor de încălzire și climatizare cu procente semnificative față de circulatoarele cu turație fixă, un argument important în proiectele care urmăresc certificare energetică. Materialele variază de la fontă pentru aplicații generale, la oțel inoxidabil 304/316 pentru apă potabilă și medii ușor corozive, iar motoarele respectă clasele de eficiență IE3 impuse de reglementările europene. Lowara e prezentă în instalații rezidențiale și comerciale de presurizare, sisteme de irigații agricole, stații de pompare pentru apă uzată și circuite industriale de răcire și transfer de lichide.`,
    ...
    industries: [
      "Instalații rezidențiale și comerciale — presurizare apă, circuite de încălzire și climatizare",
      "Industria de proces — circulație și transfer de lichide, răcire industrială",
      "Agricultură și irigații — pompare din surse de suprafață sau foraje pentru sisteme de udare",
      "Gestionarea apei uzate — stații de pompare, drenaj subsoluri, instalații municipale mici",
      "Clădiri înalte și complexe comerciale — presurizare pe verticală și recirculare apă caldă menajeră"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția pompelor centrifuge",
      "CE — marcaj de conformitate pentru pompele și circulatoarele vândute în Uniunea Europeană",
...
Materialele componentelor umede includ oțel inoxidabil pentru rezistență la emulsiile pe bază de apă și la uleiurile de ungere, cu opțiuni de rotor și lagăre dimensionate pentru particulele abrazive tipice șpanului metalic fin din prelucrările CNC. Construcția modulară permite ajustarea lungimii de imersie și a debitului fără schimbarea completă a pompei, un avantaj pentru integratorii de mașini-unelte care echipează utilaje cu rezervoare de dimensiuni diferite. Pompele Brinkmann se regăsesc pe centre de prelucrare CNC, mașini de rectificat, linii de electroeroziune și instalații industriale unde lichidul de proces trebuie recirculat continuu prin filtrare.`,
    ...
    industries: [
      "Prelucrări mecanice CNC — centre de prelucrare, strunguri, mașini de frezat",
      "Rectificare industrială — recircularea lichidului de răcire pentru mașini de rectificat",
      "Electroeroziune — filtrare și recirculare a dielectricului de proces",
      "Construcția de mașini-unelte — echipare OEM cu sisteme de răcire integrate",
      "Tratamente termice și băi de proces — transfer de lichide industriale agresive"
    ],
    certifications: [
...
Materialele acoperă bronz și alamă pentru aplicații generale cu apă și abur de presiune joasă, oțel inoxidabil pentru medii corozive sau cu cerințe de igienă, și execuții speciale pentru gaze tehnice sau medii criogenice. Fiind regulatoare auto-acționate, nu necesită alimentare electrică sau aer instrumental, ceea ce le face soluția implicită pentru puncte de reglare izolate sau pentru instalații unde fiabilitatea în lipsa utilităților auxiliare este critică. Se regăsesc în rețele de abur industrial, stații de reglare gaze tehnice, instalații de apă potabilă și circuite de proces din industria chimică și farmaceutică.`,
    ...
    industries: [
      "Rețele de abur industrial — reglare presiune și temperatură pe linii de distribuție",
...
Rotorul unic, fără etanșări dinamice supuse frecării și fără ulei de ungere în contact cu aerul vehiculat, reduce mentenanța la un nivel minim — practic doar verificarea periodică a rulmenților și a filtrului de aspirație. Zgomotul redus și lipsa vibrațiilor mecanice semnificative, comparativ cu suflantele Roots sau cu compresoarele cu piston, le fac potrivite pentru medii sensibile la zgomot, cum ar fi spațiile comerciale sau instituțiile. Suflantele FPZ se regăsesc în stații de epurare a apei, transport pneumatic de materiale granulare ușoare, ambalare industrială cu vid și aplicații medicale sau dentare unde puritatea aerului este esențială.`,
    ...
    keyProducts: [
      ...
      },
      {
        ...
        description: "Gama FPZ include variante speciale, cu materiale și toleranțe adaptate pentru funcționarea în medii cu temperatură ambiantă ridicată sau pentru vehicularea unui aer cu temperatură mai mare decât cea standard, situații frecvente în industria de proces sau în aplicații montate în spații neventilate corespunzător. Pentru medii corozive sau cu cerințe de igienă sporite, sunt disponibile execuții cu carcasă din oțel inoxidabil, potrivite pentru industria alimentară, farmaceutică sau chimică. Aceste variante păstrează aceeași construcție simplă și fiabilă a suflantei cu canal lateral, adaptând doar materialele componentelor expuse la mediul agresiv."
      },
      {
        name: "Pachete Complete cu Insonorizare și Automatizare",
        description: "Pentru instalații unde nivelul de zgomot sau integrarea în automatizarea existentă sunt cerințe de proiect, FPZ oferă suflantele montate în incinte insonorizate, complete cu filtru de aspirație, supapă de siguranță, manometru și, opțional, convertizor de frecvență pentru reglarea debitului de aer în funcție de necesarul real al procesului. Această configurație completă reduce timpul de instalare pe șantier și asigură funcționarea corectă a suflantei încă de la punerea în funcțiune, fără ajustări suplimentare de accesorii individuale. Este soluția preferată pentru stații de epurare mici și medii, unde suflanta trebuie integrată direct în automatizarea existentă a proceselor de aerare."
      }
    ],
    industries: [
...
Materialele rotorului și statorului variază de la oțel inoxidabil pentru rotor cu elastomeri precum NBR, EPDM sau FKM pentru stator, aleși în funcție de compatibilitatea chimică și de temperatura fluidului vehiculat, până la execuții complet metalice pentru fluide abrazive sau la temperaturi ridicate unde elastomerii nu ar rezista. Debitele acoperă de la câțiva litri pe oră, pentru dozare de precizie, până la câteva sute de metri cubi pe oră pentru transportul de nămoluri în stații de epurare mari. Pompele SEEPEX se regăsesc în stații de epurare, industria alimentară, farmaceutică, cosmetică, industria hârtiei și procese chimice unde debitul constant, indiferent de presiunea din sistem, este esențial pentru calitatea procesului.`,
    whyChoose: [
      "Tehnologia Smart Conveying Technology (SCT) — ajustare și înlocuire a statorului direct pe conductă, fără demontarea completă a pompei",
      "Debit constant indiferent de presiune — control precis pentru dozare și transport de fluide vâscoase sau cu solide",
      "Gamă foarte largă de materiale — de la elastomeri standard până la execuții complet metalice pentru fluide abrazive sau fierbinți",
      "Specializare exclusivă pe pompe cu șurub excentric — peste cinci decenii de perfecționare a aceluiași principiu constructiv",
      "Solicitare redusă asupra fluidului vehiculat — transport fără forfecare puternică, potrivit pentru produse alimentare sensibile la structură",
      "Acoperire largă de debite — de la dozare de câțiva litri pe oră până la sute de metri cubi pe oră pentru nămoluri"
    ],
    keyProducts: [
      {
        name: "Pompe Bloc Seria BN",
      ...
      },
      {
        ...
        description: "Pentru aplicații cu cerințe stricte de igienă, SEEPEX produce variante ale pompelor cu șurub excentric certificate pentru contact alimentar și farmaceutic, cu suprafețe interioare polizate, conexiuni clamp compatibile cu practicile CIP/SIP și materiale elastomerice aprobate pentru contact cu produse alimentare. Sunt folosite pentru transportul unor produse sensibile la forfecare, precum iaurturi cu bucăți de fruct, paste alimentare sau produse cosmetice vâscoase, unde o pompă centrifugă ar deteriora structura produsului. Debitul constant, indiferent de contrapresiunea din sistem, asigură dozare precisă în procesele de ambalare și umplere unde consistența produsului final contează."
      }
    ],
    industries: [
      ...
      "Agricultură și biogaz — transport de dejecții animale și substrat pentru instalații de biogaz"
    ],
    certifications: [
...
SAMSON produce intern practic toate componentele critice ale unui lanț de reglare — corp de robinet, actuator, poziționer și electronică de control — ceea ce elimină problemele de compatibilitate care apar la asamblarea de componente din surse diferite și simplifică diagnosticarea unei probleme de reglare. Materialele acoperă întreaga plajă cerută de industria de proces, de la oțel carbon pentru aplicații generale, la oțel inoxidabil și aliaje pe bază de nichel pentru medii corozive sau la temperaturi extreme. Robinetele și regulatoarele SAMSON se regăsesc în rafinării, centrale electrice, industria chimică și farmaceutică, oriunde reglarea precisă a debitului, presiunii sau temperaturii este critică pentru siguranța și eficiența procesului.`,
    ...
    keyProducts: [
      {
        name: "Robinet de Reglare cu Corp Glob Tip 3241",
    ...
    industries: [
      "Rafinării și petrochimie — reglare debit, presiune și temperatură pe linii de proces",
      "Centrale electrice — reglare abur, apă de alimentare cazan, circuite de răcire",
      "Industria chimică — control precis al reacțiilor și proceselor sensibile la debit",
      "Industria farmaceutică — reglare de proces în condiții de validare strictă",
      "Industria hârtiei și celulozei — control debit pe linii de proces continuu",
      "Gaze industriale și stații de reglare — reglare presiune pe rețele de distribuție"
    ],
    certifications: [
      "PED 2014/68/UE — conformitate pentru robinetele de reglare montate pe echipamente sub presiune",
      "ATEX — actuatoare și poziționeri certificate pentru zone cu risc de explozie",
...
Materialele acoperă de la oțel inoxidabil cu elastomeri standard, până la execuții complet metalice fără elastomeri pentru fluide fierbinți sau incompatibile chimic cu cauciucul. Construcția modulară a pompelor NEMO permite recondiționarea rapidă prin înlocuirea statorului și rotorului, fără achiziția unei pompe complet noi. Pompele NETZSCH se regăsesc în epurarea apelor uzate, industria alimentară și a băuturilor, industria chimică, cosmetică și farmaceutică, oriunde transportul controlat al unui fluid dificil este o cerință critică de proces, nu doar o preferință de operare.`,
    ...
    keyProducts: [
      {
        name: "Pompe cu Șurub Excentric NEMO Seria BY",
        description: "Seria BY este pompa NEMO standard pentru aplicații generale industriale, cu rotor și stator montate pe un cadru compact, potrivită pentru transportul de nămoluri, paste și lichide vâscoase cu conținut moderat de solide. Debitele acoperă o gamă largă, de la câțiva litri pe oră pentru dozare, până la zeci de metri cubi pe oră pentru transport de proces. Materialele rotorului și statorului se aleg în funcție de compatibilitatea chimică și de conținutul abraziv al fluidului, cu opțiuni de la elastomeri standard până la execuții metalice. Este soluția implicită pentru majoritatea aplicațiilor de transport al fluidelor dificile din stații de epurare și industrie de proces."
      },
      {
      ...
      },
      {
        ...
        description: "Gama TORNADO de pompe rotative cu lobi oferă un debit constant, cu pulsații reduse, potrivit pentru fluide cu vâscozitate mare, conținut de particule sau structuri sensibile la forfecare, cum ar fi produsele alimentare cu bucăți solide. Construcția fără contact între lobii rotativi reduce uzura internă și permite funcționarea în ambele sensuri de rotație, utilă pentru golirea rapidă a unei conducte sau linii de proces. Diametrele racordurilor și debitele acoperă o gamă largă de aplicații industriale, de la transferul de produse alimentare vâscoase până la transportul de nămoluri din industria chimică."
      },
      {
    ...
    industries: [
      "Epurarea apelor uzate — transport de nămoluri primare, secundare și deshidratate",
      "Industria alimentară și a băuturilor — transport de produse vâscoase sau cu bucăți solide",
      "Industria chimică — transport de fluide agresive, vâscoase sau abrazive",
      "Industria cosmetică și farmaceutică — dozare și transport de paste și geluri",
      "Industria petrolieră — transfer de produse petroliere brute și amestecuri lichid-gaz",
      "Agricultură și biogaz — transport de substrat și dejecții pentru instalații de biogaz"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția pompelor volumetrice",
      "CE — marcaj de conformitate pentru pompele NEMO și TORNADO vândute în Uniunea Europeană",
...
Această gamă completă — de la suflanta Roots simplă și robustă, până la turbosuflanta de înaltă eficiență cu rulment magnetic — permite alegerea tehnologiei optime pentru fiecare aplicație, în loc să se forțeze o singură soluție pe toate cazurile de utilizare. Materialele și execuțiile acoperă variante standard din fontă și oțel, precum și opțiuni pentru medii speciale sau zone cu risc de explozie. Echipamentele Aerzen se regăsesc în stații de epurare a apelor uzate, industria cimentului, transport pneumatic, industria petrochimică și aplicații industriale unde aerul sau gazul de proces trebuie comprimat fiabil, non-stop, ani la rând.`,
    ...
    keyProducts: [
      ...
      },
      {
        ...
        description: "Delta Hybrid combină profilul de rotor al unei suflante Roots cu un grad de precompresie internă a aerului înainte de evacuare, similar principiului folosit de compresoarele cu șurub, ceea ce reduce semnificativ consumul de energie față de o suflantă Roots clasică la aceeași presiune de lucru. Diferența de eficiență se traduce direct în economii pe factura de curent electric, relevantă mai ales pentru stațiile de epurare mari, unde suflantele de aerare funcționează non-stop și reprezintă o parte semnificativă din consumul energetic total al instalației. Păstrează totuși simplitatea mecanică și fiabilitatea suflantei Roots, fără complexitatea suplimentară a unui compresor cu șurub complet."
      },
      {
        name: "Compresoare cu Șurub Delta Screw",
        description: "Gama Delta Screw acoperă compresoare cu șurub propriu-zise, pentru aplicații care necesită presiuni mai mari decât poate oferi o suflantă Roots sau hibridă, cu eficiență energetică ridicată datorită compresiei interne controlate prin profilul rotoarelor elicoidale angrenate. Sunt folosite pentru transport pneumatic pe distanțe lungi, aerare la adâncimi mari de bazin sau alte aplicații industriale cu cerințe de presiune ridicată și debit constant. Disponibile cu răcire prin injecție de ulei sau în execuție fără ulei, în funcție de cerințele de puritate a aerului comprimat impuse de aplicație."
      },
      {
        name: "Suflante Turbo Delta Turbo",
        description: "Delta Turbo este gama de suflante turbo de mare capacitate Aerzen, cu rotor susținut pe rulmenți magnetici, fără contact mecanic și fără ulei de ungere, ceea ce elimină practic mentenanța periodică a rulmenților și oferă eficiență energetică superioară la sarcini parțiale variabile. Este soluția pentru cele mai mari stații de epurare și aplicații industriale unde debitele mari de aer trebuie livrate la un cost energetic minim pe metru cub. Electronica de control ajustează turația în funcție de necesarul real de aer al procesului, optimizând automat punctul de funcționare pentru eficiență maximă în orice moment al zilei."
      }
    ],
    industries: [
      "Epurarea apelor uzate — aerare biologică a bazinelor din stații municipale și industriale mari",
      "Industria cimentului și a materialelor de construcții — transport pneumatic de pulberi",
      "Industria petrochimică — compresoare pentru gaze de proces și aplicații speciale",
      "Transport pneumatic — vehicularea materialelor granulare pe distanțe lungi",
      "Industria alimentară — aplicații cu cerințe de aer curat, fără ulei",
      "Energie și biogaz — compresoare pentru instalații de producere și tratare a biogazului"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția suflantelor și compresoarelor rotative",
      "CE — marcaj de conformitate pentru gama Delta Blower, Hybrid, Screw și Turbo vândută în Uniunea Europeană",
...
Materialele și execuțiile constructive urmează standardele consacrate ale industriei italiene de compresoare — carcase din fontă pentru rezistență mecanică, rotoare tratate termic pentru durabilitate la funcționare continuă, și opțiuni de insonorizare pentru instalarea în medii sensibile la zgomot. Fiind parte din Ingersoll Rand, Robuschi beneficiază de acces la o rețea globală de distribuție și service, păstrând în același timp producția și inginerimea la Parma. Echipamentele Robuschi se regăsesc în stații de epurare a apelor uzate, industria cimentului, transport pneumatic de materiale granulare și aplicații industriale de vid din întreaga lume.`,
    ...
    keyProducts: [
      ...
      },
      {
        ...
        description: "Pentru instalații unde zgomotul sau integrarea în automatizarea existentă contează, Robuschi oferă suflantele și compresoarele montate în incinte insonorizate complete, cu filtru de aspirație, supapă de siguranță, instrumentație de proces și, opțional, convertizor de frecvență pentru reglarea debitului în funcție de necesarul real al aplicației. Această configurație completă reduce timpul de instalare pe șantier și elimină necesitatea de a asambla separat accesoriile individuale. Este soluția preferată pentru stații de epurare și instalații industriale unde echipamentul trebuie integrat rapid în automatizarea existentă, cu funcționare corectă încă de la punerea în funcțiune."
      }
    ],
    industries: [
...
Materialele acoperă oțel inoxidabil, titan și aliaje speciale pentru medii corozive sau cu cerințe stricte de igienă, iar dimensionarea se face pe baza datelor termice specifice fiecărei aplicații — debite, temperaturi de intrare/ieșire, pierderea de presiune admisă. Rețeaua de producție moștenită de la GEA, cu fabrici în mai multe țări europene, susține atât proiecte noi, cât și piese de schimb pentru schimbătoare instalate cu zeci de ani în urmă. Schimbătoarele Kelvion se regăsesc în industria energetică, chimică, alimentară, marină și HVAC industrial, oriunde transferul eficient de căldură între două fluide este o cerință de proces.`,
    ...
    keyProducts: [
      {
        name: "Schimbătoare de Căldură cu Plăci și Garnituri",
        description: "Schimbătoarele cu plăci și garnituri Kelvion folosesc pachete de plăci ondulate din oțel inoxidabil sau titan, strânse între ele într-un cadru cu șuruburi de tensionare, cu garnituri elastomerice care direcționează cele două fluide în canale alternante fără amestecarea lor. Construcția modulară permite ajustarea suprafeței de transfer termic prin adăugarea sau eliminarea de plăci, adaptând schimbătorul la o cerință termică nouă fără achiziția unui echipament complet diferit. Accesul facil pentru demontare și curățare le face soluția preferată pentru aplicații din industria alimentară și de proces, unde depunerile pe suprafața de transfer termic trebuie îndepărtate periodic pentru menținerea eficienței."
      },
      {
        name: "Schimbătoare Tubulare (Shell-and-Tube)",
        description: "Schimbătoarele tubulare Kelvion sunt construite dintr-un fascicul de țevi montat într-o carcasă cilindrică, cu un fluid circulând prin interiorul țevilor și celălalt prin spațiul dintre țevi și carcasă. Construcția fără garnituri elastomerice permite funcționarea la presiuni și temperaturi mult mai ridicate decât poate gestiona un schimbător cu plăci și garnituri, fiind alegerea standard pentru aplicații de proces din industria chimică, petrochimică și energetică. Materialele fasciculului de țevi se aleg în funcție de agresivitatea fluidelor vehiculate, cu opțiuni din oțel carbon, oțel inoxidabil sau aliaje speciale pentru medii corozive sau cu temperaturi extreme."
      },
      {
        name: "Sisteme de Răcire cu Aer (Aerotermice)",
        description: "Gama de aerotermice și baterii cu țevi cu aripioare Kelvion răcește fluidele de proces folosind aer atmosferic forțat cu ventilatoare, eliminând nevoia de apă de răcire și de instalațiile asociate — turnuri de răcire, tratare chimică a apei, sisteme de recirculare. Sunt o soluție tot mai căutată în zone cu resurse de apă limitate sau cu reglementări stricte privind evacuarea apei de răcire. Construcția cu țevi din oțel sau aluminiu, cu aripioare pentru mărirea suprafeței de transfer termic către aer, se dimensionează în funcție de temperatura ambiantă maximă și de debitul termic care trebuie evacuat din procesul industrial deservit."
      },
      {
    ...
    industries: [
      ...
      "Industria farmaceutică — schimbătoare pentru procese cu cerințe stricte de igienă"
    ],
    certifications: [
...
Absența garniturilor elimină principalul punct slab al schimbătoarelor cu plăci convenționale — riscul de scurgere prin degradarea elastomerului în timp — și permite funcționarea la presiuni și temperaturi mai ridicate într-un gabarit mult mai compact decât un schimbător echivalent cu plăci și garnituri sau tubular. Această compactitate reduce spațiul de montaj necesar și cantitatea de agent frigorific sau fluid termic din instalație, un avantaj important pentru sistemele care folosesc agenți frigorifici scumpi sau reglementați strict. Schimbătoarele SWEP se regăsesc în pompe de căldură, sisteme de climatizare, instalații industriale de răcire și recuperare de căldură, și rețele de termoficare urbană.`,
    ...
    keyProducts: [
      {
        name: "Schimbătoare Brazate Compacte Seria B (B8–B25)",
        description: "Modelele mici și mijlocii din seria B, de la B8 la B25, acoperă aplicații rezidențiale și comerciale — pompe de căldură, instalații de climatizare, preparare apă caldă menajeră instantanee și sisteme mici de recuperare de căldură. Construcția complet brazată, cu plăci din oțel inoxidabil unite în cuptor cu vid, oferă o suprafață de transfer termic compactă într-un gabarit mic, potrivit pentru montaj în spații restrânse, tipice centralelor termice de apartament sau unităților de climatizare compacte. Numărul de plăci se ajustează pentru fiecare aplicație, iar brazarea din cupru acoperă majoritatea agenților frigorifici uzuali și a aplicațiilor cu apă."
      },
      {
        name: "Schimbătoare Brazate Industriale Seria B (B35–B120)",
        description: "Modelele mijlocii și mari din seria B, de la B35 la B120, acoperă aplicații industriale cu debite termice mai mari — instalații de răcire industrială, sisteme centralizate de climatizare pentru clădiri mari și procese industriale cu cerințe de transfer termic ridicate. Păstrează aceeași construcție brazată fără garnituri, cu avantajul unui gabarit mult mai compact decât un schimbător echivalent cu plăci și garnituri, ceea ce reduce spațiul de montaj necesar în centrale termice sau camere tehnice cu spațiu limitat. Presiunile de lucru admise sunt superioare schimbătoarelor cu garnituri elastomerice, datorită construcției complet sudate."
      },
      {
        name: "Schimbătoare de Mare Capacitate Seria B (B220 și peste)",
    ...
    industries: [
      "Pompe de căldură — schimbătoare pentru sisteme rezidențiale, comerciale și industriale",
      "Climatizare industrială (HVAC) — răcire și recuperare de căldură pentru clădiri mari",
      "Rețele de termoficare urbană — module de racordare la rețeaua centralizată de căldură",
      "Industria alimentară — pasteurizare și răcire de proces în gabarit compact",
      "Industria navală — sisteme de răcire compacte pentru spații limitate la bordul navelor",
      "Refrigerare comercială și industrială — schimbătoare pentru sisteme de răcire cu agenți frigorifici"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția schimbătoarelor de căldură brazate",
...
Materialele acoperă oțel inoxidabil austenitic pentru majoritatea aplicațiilor industriale, cu opțiuni de titan sau aliaje speciale pentru medii puternic corozive, precum apa de mare sau anumite chimicale agresive. Construcția modulară a schimbătoarelor cu plăci și garnituri permite ajustarea suprafeței de transfer termic prin adăugarea de plăci suplimentare, dacă cerințele termice ale procesului cresc după instalarea inițială. Schimbătoarele Funke se regăsesc în industria energetică, navală, chimică și de procesare a alimentelor, oriunde este nevoie de o soluție de transfer termic dimensionată exact pentru aplicația respectivă, nu de un model generic supradimensionat.`,
    ...
    keyProducts: [
      {
        name: "Schimbătoare de Căldură cu Plăci și Garnituri FP",
      ...
      },
      {
        ...
        description: "Pentru proiecte noi, Funke oferă calcul termic personalizat pornind de la debitele, temperaturile de intrare și ieșire și pierderea de presiune admisă specificate de client, alegând tehnologia de schimbător potrivită pentru cerințele exacte ale aplicației. Pentru schimbătoarele deja instalate, sunt disponibile plăci și garnituri de schimb, precum și servicii de recondiționare care restabilesc performanța termică inițială fără achiziția unui echipament complet nou. Această abordare orientată pe proiect, nu doar pe vânzarea unui model standard din catalog, este utilă mai ales în instalații industriale cu cerințe termice specifice sau neuzuale."
      }
    ],
    industries: [
      "Industria energetică — răcire sisteme auxiliare, recuperare de căldură din procese",
      "Industria navală — schimbătoare de căldură pentru sisteme de răcire la bordul navelor",
      "Industria chimică și petrochimică — schimbătoare de proces pentru medii agresive",
      "Industria alimentară — pasteurizare și răcire de proces",
      "Industria metalurgică — răcirea lichidelor de proces și a sistemelor hidraulice",
      "HVAC industrial — recuperare de căldură pentru clădiri și complexe industriale"
    ],
    certifications: [
      "ISO 9001 — management al calității pentru proiectarea și producția schimbătoarelor de căldură cu plăci și tubulare",
