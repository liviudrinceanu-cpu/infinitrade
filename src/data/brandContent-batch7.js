export const brandContentBatch7 = {
  'continental-belts': {
    founded: '1871',
...
Am livrat soluții de transmisie pentru mașini de ambalare, pompe industriale, ventilatoare, compresoar, echipamente agricole și linii de producție din toată lumea. Curelele Continental rulează în condiții extreme - de la frigul arctic din instalațiile de refrigerare la căldura cuptoarelor industriale - și rezistă ani de zile fără întreținere. Când ai nevoie de transmisie fiabilă care nu te lasă, ai nevoie de Continental.`,
    ...
    certifications: [
      ...
      'ISO 14001:2015 - Management de mediu pentru producție sustenabilă',
    ...
    industries: [
      ...
      'Ambalare și procesare',
      'Agricultură și echipamente agricole',
      'Industria textilă',
      'Mașini-unelte și prelucrare',
      'Pompe și compresoar industriale',
      'Ventilatoare și sisteme HVAC',
...
Am instalat peste 2 milioane de sisteme VRV în lume - de la birouri mici la aeroporturi, de la fabrici la hoteluri de 5 stele. Tehnologia noastră Heat Recovery permite încălzire și răcire simultană în zone diferite, economisind energie prin recuperarea căldurii reziduale. Când ai nevoie de climatizare care funcționează perfect 24/7/365, Daikin e singura alegere profesională.`,
    ...
    certifications: [
      'ISO 9001:2015 - Calitate certificată producție',
      'ISO 14001:2015 - Management de mediu',
      'ISO 50001 - Management energetic',
      'Eurovent Certified Performance - Performanțe verificate independent',
      'CE Marking - Conformitate UE',
      'F-Gas Regulation - Gaze refrigerente certificate',
      'AHRI Certified - Air-Conditioning, Heating, and Refrigeration Institute',
      'Eco-Design Directive - Produse eficiente energetic'
    ],
    industries: [
      'Clădiri de birouri și business center',
      'Hoteluri și spații de cazare',
      'Centre comerciale și retail',
      'Spitale și unități medicale',
      'Fabrici și hale industriale',
      'Datacenter-uri și servere IT',
      'Laboratoare și camere curate',
...
Am dezvoltat conceptul de protecție împotriva trăsnetului în zone cu risc de explozie (ATEX) și soluții speciale pentru rețele IT medicale unde siguranța pacientului e prioritate zero. Când instalația ta trebuie să funcționeze chiar și după trăsnet direct de 200 kA, ai nevoie de protecție DEHN.`,
    ...
    certifications: [
      ...
      'IEC 61643-11 - Standard internațional descărcătoare',
      'EN 50164-1 - Componente sisteme protecție trăsnet',
      'UL 1449 - Listed pentru piața SUA',
      'ATEX / IECEx - Zone cu atmosferă explozivă',
      'CE Marking - Conformitate directivă joasă tensiune',
      'VDE Tested - Verificare independentă Germania',
      'KEMA Quality Mark - Certificare Olanda'
    ],
    industries: [
      'Energie regenerabilă (solar, eolian)',
      'Telecomunicații și rețele date',
      'Industria petrol și gaz',
      'Industria chimică și farmaceutică',
      'Datacenter-uri și IT',
      'Spitale și unități medicale',
      'Aeroporturi și infrastructură transport',
...
Producem peste 200 de tipuri de scule electrice, toate testate în condiții extreme de șantier: praf, umezeală, temperaturi de la -20°C la +50°C, căderi pe beton de la 2 metri înălțime. Când lucrezi în construcții, instalații sau fabricație industrială și nu ai timp de defecțiuni, iei DeWalt și știi că merge.`,
    ...
    certifications: [
      'CE Marking - Conformitate UE scule electrice',
      'GS Geprüfte Sicherheit - Certificat siguranță Germania',
      'UL Listed - Certificare siguranță SUA',
    ...
    industries: [
      ...
      'Tâmplărie și prelucrare lemn',
      'Construcții metalice și sudură',
      'Instalații HVAC',
      'Industria auto - service și reparații',
      'Întreținere industrială',
      'Montaj mobilier și amenajări',
...
Aparatele noastre de respirat cu aer comprimat (SCBA) echipează pompierii din toată Europa: butelii carbon composite de 6 litri la 300 bar, autonomie 30-45 minute, măști panoramice cu vizor antiabraziv, sistem PASS (Personal Alert Safety System) care alarmează automat dacă pompierul rămâne imobil. Când viața ta depinde de echipament, alegi Dräger.`,
    ...
    certifications: [
      ...
      'ATEX - Directive 2014/34/EU echipamente atmosfere explozive',
      'IECEx - Certificare internațională Ex',
      'CE Marking - Conformitate UE',
      'EN 137 - Standard european aparate respirat pompieri',
      'EN 60079-29-1 - Detectoare gaze în atmosfere explozive',
      'SIL 2/3 - Safety Integrity Level pentru sisteme critice'
    ],
    industries: [
      'Petrol & gaz (rafinării, extracție)',
      'Industria chimică și petrochimică',
      'Industria farmaceutică',
      'Pompieri și servicii de urgență',
      'Mine și cariere',
      'Tuneluri și metrou',
      'Tratare apă și canalizare',
      'Industria alimentară (CO₂)',
...
Manometrele noastre sunt peste tot: de la măsurare presiune în conducte de apă până la monitorizare filtre în camere curate, de la verificare debit ventilatoare până la control presiune în reactoare chimice. Când ai nevoie de un instrument care pur și simplu merge fără să te complice, Dwyer e alegerea evidență.`,
    ...
    certifications: [
      'ISO 9001:2015 - Calitate certificată producție',
      'CE Marking - Conformitate directivă UE',
...
Producem în 30 de fabrici din Europa, America și Asia, cu controale calitate stricte la fiecare pas. Când proiectezi o instalație electrică care trebuie să funcționeze fără probleme 20-30 de ani, când ai nevoie de piese de schimb garantate și documentație tehnică completă, alegi Eaton și dormi liniștit.`,
    ...
    certifications: [
      ...
      'ISO 14001:2015 - Management de mediu',
      'ISO 50001 - Management energetic',
      'IEC 61439 - Tablouri electrice de distribuție BT',
      'IEC 60947 - Aparataj BT (contactoare, relee)',
      'UL 508 - Industrial Control Equipment (piața SUA)',
      'CE Marking - Directivă Joasă Tensiune 2014/35/EU',
      'EAC - Certificare piața Rusia și Eurasia'
    ],
    industries: [
      'Fabrici și producție industrială',
      'Clădiri comerciale și birouri',
      'Datacenter-uri și IT infrastructure',
      'Spitale și unități medicale',
      'Hoteluri și hospitality',
      'Aeroporturi și infrastructură transport',
      'Utilități (apă, energie, canalizare)',
      'Petrol & gaz',
      'Industria alimentară',
...
Avem peste 60 de ani de experiență în filtrare industrială: de la vopsele și rășini, la produse alimentare și băuturi, de la apă de proces la uleiuri hidraulice, de la produse chimice la tratare ape uzate. Când procesul tău nu poate sta pentru schimbare filtre sau când particulele trebuie eliminate fără compromis, Eaton Filtration e soluția ingenierească corectă.`,
    ...
    industries: [
      ...
      'Industria chimică și petrochimică',
      'Tratare apă și ape uzate',
      'Vopsele, lacuri și rășini',
      'Industria hârtiei și celulozei',
      'Industria auto - lubrifianți și lichide',
      'Electronice - apă ultra-pură',
      'Rafinării petrol',
      'Industria cosmetică'
    ],
...
Sistemul DeltaV DCS e vârful de lance în control de proces: redundanță completă (controllere duble, rețele duale, servere fail-over), scalabilitate de la 50 până la 25,000 I/O points, interfață operator modernă touch cu grafice HD, integrare nativă sisteme de siguranță SIS (Safety Instrumented Systems) conform IEC 61511. Când procesul tău nu poate sta nicio secundă și când calitatea produsului depinde de control precis, Emerson e standard în industrie.`,
    ...
    certifications: [
      'ISO 9001:2015 - Management calitate producție',
      'IEC 61508 - Functional safety SIL 2/3',
      'IEC 61511 - Safety instrumented systems pentru proces',
