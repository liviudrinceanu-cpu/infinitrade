export const brandContentBatch11 = {
  'legrand': {
    founded: 1865,
...
Legrand acoperă atât nevoile unei locuințe, de la prize și întrerupătoare până la sisteme complexe pentru instalații industriale, cât și pe cele ale unei fabrici întregi. Echipa noastră tehnică te poate ajuta să alegi configurația potrivită pentru proiectul tău. Indiferent dacă renovezi o casă sau echipezi o fabrică, Legrand are soluția tehnică corectă.`,
    ...
    keyProducts: [
      {
        ...
        description: 'Când instalezi produsele din seriile Legrand Céliane, Valena sau Mosaic, nu montezi doar echipamente electrice – construiești o interfață completă între utilizatori și rețeaua electrică. Designul modular permite combinații nelimitate: de la prize simple la module USB, prize RJ45, HDMI, chiar și module audio. Mecanismele sunt garantate pentru peste 100,000 de manevre, clipsurile de fixare se montează fără șuruburi, iar finisajele variază de la plastic ABS la sticlă temperată, metal brushed sau chiar lemn natural. În birourile moderne vedem tot mai des montaje flush în birouri cu module integrate USB-C și wireless charging. Pentru medii industriale, varianta Plexo cu IP55 rezistă la jet de apă și praf. Fiecare serie are certificări VDE și conformitate cu standardele IEC 60884.'
      },
      {
    ...
    industries: [
      'Construcții rezidențiale – prize, întrerupătoare, tablouri',
      'Clădiri de birouri – cablare structurată, automatizare',
      'Centre de date – PDU-uri, managementul energiei',
      'Industrie – tablouri modulare, contactoare',
      'Hoteluri – sisteme control acces, automatizare camere',
      'Retail – iluminat, prize comerciale',
...
Sortimentul Loctite folosit cel mai des în industrie include threadlockere 243 și 270, adezivi instant 401 și 406, etanșant 577 pentru filete hidraulice și adeziv retaining 638 pentru rulmenți. Echipa tehnică te poate ajuta să alegi produsul corect pentru aplicația ta specifică.`,
    ...
    certifications: [
      'ISO 9001 – Managementul calității producție',
      'ISO 14001 – Management de mediu',
      'NSF – Certificare produse pentru industria alimentară',
      'UL – Certificare materiale pentru aplicații electrice',
      'REACH – Conformitate substanțe chimice UE',
      'RoHS – Restricție substanțe periculoase',
      'FDA – Aprobare produse contact alimentar',
      'Lloyd\'s Register – Certificare industrie navală'
    ],
    industries: [
      'Automotive – asamblare motoare, transmisii, suspensii',
      'Industrie grea – reparații utilaje, montaj rulmenți',
      'Hidraulică și pneumatică – etanșare filete, flanșe',
      'Aeronautică – îmbinări structurale certificate',
      'Electronică – fixare componente pe PCB-uri',
      'Construcții metalice – îmbinări structurale',
...
Seria Lovato BF acoperă contactoare modulare 9A-95A, iar seria B contactoare heavy-duty până la 800A, alături de relee termice RF și soft startere DMC. Dacă ai nevoie de asistență tehnică pentru dimensionarea corectă a protecțiilor, echipa noastră te poate ajuta cu calcule și scheme de comandă.`,
    ...
    certifications: [
      'ISO 9001 – Sistem management calitate',
      'ISO 14001 – Management de mediu',
    ...
    industries: [
      'Industrie de proces – comandă pompe, mixere, transportoare',
      'HVAC – control ventilatoare, compresoare climatizare',
      'Tratare apă – stații pompare, aerare',
      'Agricultură – sisteme irigații, ventilatoare ferme',
      'Food & Beverage – linii procesare, refrigerare',
      'Textile – comenzi motoare mașini de cusut industriale',
