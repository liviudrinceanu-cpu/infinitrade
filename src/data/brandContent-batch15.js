export const brandContentBatch15 = {
...
Ceea ce diferențiază Siemens de competiție e profunzimea gamei: SITRANS F (debitimetre cu ultrasunete, electromagnetic, masic Coriolis, vortex, termic), SITRANS P (traductoare de presiune absolută/relativă/diferențială până la 1000 bar), SITRANS L (nivel radar, ultrasonic, cu ghidaj de undă), SITRANS T (temperatură RTD și termocuple), plus seria de analizoare SITRANS C (oxigen dizolvat, pH/redox, conductivitate, turbiditate). Toate proiectate să funcționeze 20+ ani în condiții industriale grele, cu aprovizionare garantată de piese de schimb și backward compatibility impecabilă.`,
    ...
    whyChoose: [
      'Precizie și repetabilitate excepționale - specificațiile sunt garantate nu doar pe hârtie ci și în practică după ani de funcționare',
      ...
      'Suport tehnic de nivel mondial - documentație impecabilă, training-uri dedicate, asistență locală în România',
      'Aprovizionare pe termen lung garantată - Siemens menține producția și suportul pentru minimum 15 ani de la lansare',
    ...
    keyProducts: [
      ...
      },
      {
        ...
        description: `Traductoarele SITRANS P sunt standardul industriei pentru măsurarea presiunii în orice condiții. Seria SITRANS P320 pentru aplicații generale (aer comprimat, hidraulică) cu robusteță industrială și raport calitate/preț excelent. SITRANS P410 compact cu membrană aflorată (flush) pentru fluide vâscoase sau cristalizabile. SITRANS P500 cu izolare dielectrică completă pentru medii agresive chimic. SITRANS P DS III cu separator de presiune pentru temperaturi extreme sau fluide toxice. Game de măsurare de la 100 mbar până la 1000 bar (absolute, relative, diferențiale), acuratețe până la ±0.04%, stabilitate long-term impecabilă, output 4-20mA/HART/PROFIBUS PA, display opțional. Rezistență la vibratii, șocuri, EMC conform celor mai stricte standarde militare și navale.`
      },
      {
    ...
    industries: [
      ...
      'Food & Beverage',
      'Water & Wastewater',
      'Energie (centrale termice, nucleare, regenerabile)',
      'Pulp & Paper',
      'Metallurgie',
      'Ciment și minerit',
...
Dar SKF nu e doar sisteme automate - au și gamă completă de unelte manuale (pistoale de gresat, pompe cu pârghie, pompe cu picior), cartușe pre-umplute, unsori și uleiuri premium LGMT/LGHP/LGWA dezvoltate în laboratoarele proprii pentru rulmenți în condiții extreme. Plus divizia SKF Reliability Systems care oferă consultanță pentru optimizarea programului de lubrifiere - nu vinzi doar echipament, vinzi expertise acumulat în peste un secol de experiență cu tribologie.`,
    ...
    certifications: [
      ...
      'ISO 14001 Environmental Management',
      'ISO 45001 Occupational Health & Safety',
      'ATEX pentru sisteme în zone explozive',
      'NSF H1 pentru lubrifianți food-grade',
      'API (American Petroleum Institute) pentru aplicații oil & gas',
      'Marine approvals (DNV, ABS) pentru aplicații navale',
      'ISO 21469 pentru lubrifianți în procesele alimentare'
    ],

    industries: [
      'Minerit și excavare (excavatoare mari, drag-lines)',
      'Siderurgie (laminoare, furnale, macarale)',
      'Ciment (mori, cuptoare rotative, conveioare)',
      'Pulp & Paper (mașini de hârtie, digestoare)',
      'Energie (turbine eoliene, hidrocentrale)',
      'Automotive (linii de producție, roboți)',
      'Food & Beverage (linii de îmbuteliere, ambalare)',
      'Maritime (macarale portuale, grue)',
      'Construcții (utilaje grele, macarale turn)',
...
Dar SMC nu e doar despre catalog imens - e și despre inovație continuă. Au fost primii cu valve pe bus de teren (DeviceNet, PROFIBUS, EtherCAT), primii cu cilindri fără tije cu magnet dublu pentru pozitionare precisă, primii cu valve proporționale digitale pentru controlul fin al presiunii și debitului. Iar rețeaua de distribuție SMC acoperă întreaga lume - oriunde ai fi, ai acces rapid la produse și suport tehnic local. În România lucrăm cu gama completă SMC, cu ingineri de aplicații care te ajută să alegi configurația optimă.`,
    ...
    industries: [
      ...
      'Plastics (injectie, suflare, termoformare)',
  ...
  'spirax-sarco-thermal': {
    ...
    employees: '6,500+',
    overview: `Spirax Sarco e autoritatea mondială în tehnologia aburului industrial - dacă există o aplicație care implică generare, distribuție, control sau condensare abur, britanicii au soluția optimă și expertise-ul care te asigură că funcționează corect. De la oale de condens (steam traps) care evacuează condensul fără să piardă abur live, până la stații de reducere presiune complet automatizate, până la schimbătoare de căldură plate sau tubulare, totul e proiectat cu o înțelegere profundă a termodinamicii și o obsesie pentru eficiență energetică.

Am lucrat cu echipamente Spirax Sarco în diverse industrii - food processing, textile, chimie, pharma - și de fiecare dată ne-a impresionat abordarea sistemică. Nu vinzi doar un steam trap - analizezi întreaga rețea de abur, identifici pierderile (leakage la trapele defecte, condensul returnat incomplet, presiunea prea mare unde nu e necesară), propui soluții integrate și demonstrezi ROI-ul prin economii de combustibil măsurabile. Spirax oferă chiar servicii de audit energetic gratuit cu cameră termografică și echipament ultrasonic pentru detectarea trapelor blocate sau leaking.

Dar ceea ce îi diferențiază pe britanici e calitatea ingineriei: trapele termodinamice TD cu disc din inox super-polizat care funcționează 10+ ani fără mentenanță, regulatoarele pilot-operated care mențin presiunea constantă ±0.01 bar chiar la variații mari de debit, schimbătoarele plate cu eficiență termică 95%+ datorită design-ului optimizat CFD. Plus bibliotecă tehnică imensă (manuale, standarde, calculatoare online) și training-uri dedicate pentru ingineri - Spirax Academy oferă cursuri gratuite despre steam engineering la fața locului.`,

    whyChoose: [
      'Expertiza unică în tehnologia aburului - 136 ani de experiență acumulată și inovație continuă',
      'Economii energetice dovedite - sistemele Spirax reduc consumul de combustibil cu 10-30% prin eliminarea pierderilor',
      'Fiabilitate și durabilitate excepționale - produse proiectate pentru 20+ ani funcționare continuă în condiții grele',
    ...
    certifications: [
      ...
      'ATEX pentru echipamente în zone explozive',
      'FDA 21 CFR pentru aplicații pharma și food',
      '3-A Sanitary Standards pentru food & beverage',
      'Marine approvals (Lloyd\'s, DNV) pentru aplicații navale'
    ],

    industries: [
      'Food & Beverage (breweries, lactate, conserve)',
      'Pharmaceutical (sterilizare, uscare, reacții)',
      'Textile (vopsire, finishing, presare)',
      'Pulp & Paper (digestoare, uscătoare)',
      'Chimie și petrochimie (reactoare, distilare)',
      'Oil & Gas (preîncălzire, stripping)',
      'Hospitals (sterilizare, spălătorii, încălzire)',
      'Laundries (spălare industrială, călcare)',
      'District heating (stații termice)',
  ...
  'stahlwille': {
    ...
    employees: '800+',
    overview: `Stahlwille e aristocrația sculelor de mână germane - acolo unde Hazet și Gedore sunt deja considerate premium, Stahlwille se ridică cu încă un nivel prin calitatea materialelor, precizia fabricației și atenția la detalii care face diferența în aplicații industriale critice. Nu sunt scule pentru garajul casei - sunt instrumente de precizie pentru aerospace, automotive de top, energie nucleară, oil & gas offshore, unde o cheie strânsă la cuplul greșit poate însemna dezastru, iar o chitate spulberată poate cauza oprirea unei linii de producție care costă zeci de mii euro pe oră.

Am testat chei dinamometrice Stahlwille față de competiție (Norbar, CDI, Snap-on) și diferența se vede: mecanism intern robust din oțel forjat (nu turnat), calibrare în fabrică cu echipamente metrologice trasabile PTB (Physikalisch-Technische Bundesanstalt - institutul național metrologic german), clicking mechanism precis și repeatable ±3% chiar după 50,000+ de cicluri. Comparativ, multe brand-uri "bugetare" ajung la ±6-8% după câteva mii de cicluri.
...
Dar Stahlwille nu e doar dinamometrice - au gamă completă de tubulare industriale (sertare modulare MASTERBOX cu organizare perfectă), chei inelare și combinate (OPEN-BOX cu design deschidere 15° pentru unghi mic de lucru), torx-uri și hex cu tratament special anti-slipping, biți pentru înșurubătoare cu impact. Totul ambalat în cutii metalice sau polymer de înaltă rezistență, cu seriale individuale pentru calibrare și verificare periodică. Investiție pentru decenii, nu consumabile de o dată.`,
    ...
    whyChoose: [
      ...
      'Durabilitate excepțională - oțel crom-vanadiu forjat, tratament termic controlat, finisare cromată anti-coroziune',
      'Ergonomie superioară - mânere soft-grip anatomice care reduc oboseala în utilizare prelungită',
      'Garanție pe viață pentru defecte de fabricație - Stahlwille înlocuiește sau repară gratuit orice scule defecte non-abusive',
    ...
    certifications: [
      'ISO 9001 Quality Management',
      'ISO 14001 Environmental Management',
      'Calibrare trasabilă PTB (Physikalisch-Technische Bundesanstalt)',
      'DKD/DAkkS acreditare laboratoare calibrare Germania',
      'GS (Geprüfte Sicherheit) - testate siguranță TÜV',
      'Conformitate DIN/ISO 6789 pentru chei dinamometrice',
      'VDE pentru scule izolate electric (până 1000V)',
      'ESD-safe pentru scule în medii electronice sensibile'
    ],

    industries: [
      'Aerospace (asamblare avioane, helicopter MRO)',
      'Automotive premium (Mercedes, BMW, Audi production lines)',
      ...
      'Wind energy (turbine eoliene - strângeri critice la cuplu)',
      'Heavy machinery (excavatoare, bulldozere, macarale)',
      'Marine (șantiere navale, mentenanță nave)',
      'Motorsport (Formula 1, endurance racing)',
...
Dar TE nu e doar manufacturing scale - e și inovație continuă. Au fost pionieri ai conectorilor circular M8/M12 pentru senzori industriali, ai conectorilor hermetic sealed pentru aerospace/defense, ai senzorilor MEMS de presiune și accelerație. Investesc masiv în R&D pentru tehnologii next-gen: conectori high-speed pentru 112 Gbps datacom, senzori LiDAR pentru vehicule autonome, antene mmWave pentru 5G. Și suportul tehnic e impresionant: biblioteca online cu modele 3D CAD, drawings, specificații, application notes pentru fiecare produs.`,
    ...
    certifications: [
      ...
      'UL, CE, CSA, VDE pentru produse electrice',
      'RoHS/REACH compliance pentru restricții substanțe'
    ],

    industries: [
      'Automotive (conectică, senzori, relee pentru EV/hybrid)',
      'Aerospace & Defense (conectori hermetic sealed, harsh environment)',
      'Industrial Automation (senzori M12, I/O connectors, Ethernet)',
      'Telecom & Datacom (conectori high-speed, fiber optic)',
      'Medical (conectori sterilizabili, senzori biocompatibili)',
      'Energy (smart grid, renewable, power distribution)',
      'Consumer Electronics (smartphones, wearables, tablets)',
      'Appliances (conectică white goods)',
      'Railway (conectori vibration-resistant)',
...
Dar Tesa nu e doar comparatoare - au și rugozimetre portabile pentru măsurarea parametrilor de rugozitate Ra/Rz/Rq conform ISO 4287 (esențial în verificarea suprafețelor rectificate/polizate), coloane de măsurat pentru verificări dimensionale complexe (șabloane, matrițe, piese prismatice), chiar aparate de măsurat rotunditate pentru arbori și alezaje. Totul cu software dedicat pentru analiza datelor și generare rapoarte de calitate conform ISO 9001/IATF 16949.`,
    ...
    whyChoose: [
      'Precizie elvețiană legendară - rezoluție 0.1 μm (0.0001 mm), repetabilitate sub ±0.2 μm',
      ...
      'Durabilitate excepțională - instrumente proiectate pentru utilizare intensivă 10+ ani în producție'
    ],
    ...
    certifications: [
      ...
      'RoHS compliance pentru restricții substanțe'
    ],
...
Dar Testo nu e doar hardware - au și ecosistem software complet: aplicația Testo Smart Probes pentru configurare instrumente și vizualizare măsurători pe smartphone/tablet, platforma Testo Cloud pentru stocare și analiză date în timp real (perfect pentru monitoringul 24/7 al depozitelor frigorifice sau camerelor curate), software-uri dedicate pentru industrii specifice (testo IRSoft pentru analiza imaginilor termografice, testo EasyClimate pentru sizing sisteme HVAC). Totul proiectat să simplifice munca tehnicianului și să genereze rapoarte profesionale pentru clienți în câteva click-uri.`,
    ...
    whyChoose: [
      'Robustețe legendară - instrumente care supraviețuiesc căderilor, prafului, umezelii din realitatea zilnică a tehnicienilor',
      ...
      'Baterie long-life - autonomie excepțională (săptămâni/luni pentru data loggere, zile pentru instrumente portabile)',
    ...
    certifications: [
      'ISO 9001 Quality Management',
      'ISO 14001 Environmental Management',
      'ISO 17025 acreditare laboratoare calibrare (DKD/DAkkS)',
      'Conformitate EN 50379 pentru analizoare gaze combustie',
      'Conformitate EN 13187 pentru termografie clădiri',
      'FDA CFR 21 Part 11 pentru data loggere pharma',
      'HACCP compliance pentru monitorizare alimentară',
      'CE marking pentru toate instrumentele electrice'
    ],

    industries: [
      'HVAC (instalatori, service climatizare/ventilație/încălzire)',
      'Food & Beverage (monitorizare HACCP depozite/transport/producție)',
      'Pharmaceutical (validare camere curate, monitorizare frigidere vaccin)',
      'Energie (reglaj arzătoare, audit energetic clădiri)',
      'Facility Management (monitorizare clădiri, optimizare consum energie)',
      'Automotive (validare cabine vopsire, curățare aer)',
      'Electronics (camere curate asamblare, control umiditate)',
      'Logistică (monitorizare transport refrigerat)',
      'Healthcare (spitale - presiune negativă camere izolare, sterilizare)',
...
Dar Trane nu e doar about hardware - oferă și servicii de energy audit, building optimization (analiza consumurilor și propuneri retrofit pentru economii 20-40%), BMS integration (integrare în sisteme BACnet, Modbus, LonWorks), chiar ESCO (Energy Service Company) unde Trane finanțează modernizarea și se recuperează din economiile de energie generate. Investiția Trane nu e doar în echipament - e în eficiență pe 15-20 ani cu suport continuu.`,
    ...
    keyProducts: [
      {
        ...
        description: `Chillerele centrifugale Trane CenTraVac sunt apogeul tehnologiei de refrigerare pentru clădiri mari (peste 1 MW putere frigorifică). Compresor centrifugal cu mai multe stagii (2-3 stage compression) pentru rate mari de compresie eficiente, antrenat de motor electric sincron cu magneți permanenți (variable speed 10-100% capacity modulation fără pierderi mecanice). Magnetic bearings - lagăre cu levitație magnetică, zero ungere, zero frecare, zero mentenanță pentru 30+ ani. Condensator și evaporator din țevi din cupru cu îmbunătățiri de transfer termic (rifled tubes) pentru suprafață compactă. Refrigerant R-134a (low GWP) sau R-513A (ultra-low GWP <1) pentru conformitate F-Gas. Eficiență excepțională: EER 6-7+ (coeficient performanță), IPLV (eficiență la sarcină parțială) 8-10+ datorită VSD și stagiilor de compresie modulante. Puteri 250-10,000 kW frigorific (70-2800 tone refrigerare US). Controler Tracer AdaptiView integrat: optimizare automată funcție de load, temperaturi exterioare, tarif energie (demand response), diagnosticare predictivă cu alertare remotă. Aplicații: clădiri înalte (office towers), spitale, universități, aeroporturi, mall-uri, datacentere. Montaj: în sala tehnică la subsol sau acoperiș, necesită turnuri răcire (cooling towers) separate sau dry-coolers.`
      },
      {
    ...
    certifications: [
      ...
      'Eurovent certification pentru performanță echipamente HVAC',
      'AHRI (Air-Conditioning, Heating, and Refrigeration Institute) USA',
      'CE marking și PED pentru echipamente sub presiune',
      'F-Gas certification pentru manipulare refrigeranți'
    ],

    industries: [
      'Clădiri comerciale (office buildings, mall-uri, hoteluri)',
      'Sănătate (spitale, clinici, centre medicale)',
      'Pharmaceutical (fabrici cu camere curate GMP)',
      'Datacentre (cooling high-density IT equipment)',
      'Educație (universități, școli, campus-uri)',
      'Retail (magazine, supermarketuri, restaurante)',
      'Industrie (fabrici cu cerințe de climatizare proces)',
      'Aeroporturi (terminale pasageri, hangare)',
      'Districting heating/cooling (rețele termice urbane)',
